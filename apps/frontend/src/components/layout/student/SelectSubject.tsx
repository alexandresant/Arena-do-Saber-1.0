...
export function DisciplineCard() {
    ...
    const handleCardClick = (slug: string, isAvailable: boolean) => {
        if (isAvailable) {
            // Agora ele navega corretamente para a página de aulas passando o slug
            router.push(`/lessons?subject=${slug}`)
        } else {
            console.warn("Nenhum material encontrado para esta disciplina.")
        }
    }
    ...
    return (
        ...
        ${isAvailable
                                ...
                                // Ajustado para passar o slug e a disponibilidade
                                onClick={() => handleCardClick(slug, isAvailable)}
                            >
